// Your Code Here+
//window.prompt('Do you head left of right?')
...
Do you follow it, or continue on your path?`)
    if (secondAnswer === 'follow it') {
        ...
        if(thirdAnswer === 'stay') {
            ...
            let sfourthAnswer = window.alert('After leaving the cat colony, you are never able to find it again; without proof, no one believes your story, which passes into legend nonetheless.')
        }
